...
export default function TermsConditionsPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-16 text-sm leading-7 text-ink sm:px-8 sm:py-20">
      <article className="space-y-6">
        <strong className="block text-2xl leading-none">
          Terms &amp; Conditions
        </strong>
        <p>
          These terms and conditions apply to the InkFlow app (hereby referred
          to as "Application") for mobile devices that was created by Nirmal
          Chhetri (hereby referred to as "Service Provider") as a Freemium
          service.
        </p>
        <p>
        ...
        <div>
          <p>
            The Application incorporates Artificial Intelligence (AI)
            technologies to provide certain features or services. By using the
            Application, you acknowledge and agree that AI may be used to
            process data and deliver functionalities. The Service Provider
            ensures that all AI usage complies with applicable laws and is
            designed to benefit the user experience.
          </p>
        </div>
        <p>
        ...
        <p>These terms and conditions are effective as of 2026-03-05</p>
        <strong className="block text-xl leading-none">Contact Us</strong>
        <p>
