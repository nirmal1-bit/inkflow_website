      ...
      <div className="mx-auto max-w-4xl">
        <div className="rounded-[28px] border border-accent/10 bg-[rgba(250,248,245,0.9)] shadow-[0_20px_60px_rgba(26,26,46,0.08)] p-6 sm:p-10 lg:p-12">
          <header className="mb-10">
            <p className="badge mb-4">Terms &amp; Conditions</p>
          ...
          <article className="space-y-8 text-sm sm:text-[15px] leading-7 text-ink/80">
            ...
            <section className="space-y-3">
              <p>
                ...
                technologies to provide certain features or services. By using
                the Application, you acknowledge and agree that AI may be used
                to process data and deliver functionalities. The Service
                Provider ensures that all AI usage complies with applicable laws
                and is designed to benefit the user experience.
              </p>
              <p>
            ...
            <section className="space-y-3">
              ...
              <p>These terms and conditions are effective as of 2026-03-29</p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                ...
                Provider at morespacenirmal@gmail.com.
              </p>
            </section>
